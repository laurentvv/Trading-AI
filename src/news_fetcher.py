...
def fetch_alpha_vantage_news(ticker: str, api_key: str):
    ...
    try:
        ...
        overall_sentiment = (
            sentiment_score / sentiment_count if sentiment_count > 0 else 0
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Fetch news headlines and sentiment from Alpha Vantage."
    )
    ...
    output = {"headlines": headlines, "sentiment": sentiment}
