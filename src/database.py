...
def get_latest_portfolio_state(ticker: str = 'QQQ') -> Optional[Tuple[float, float, float, float]]:
    """
...
def get_latest_transaction(ticker: str = 'QQQ') -> Optional[Tuple[str, str, float, float, float]]:
    """
