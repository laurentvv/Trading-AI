...
- **Timeout siklus**: setiap siklus per ticker dibatasi 15 menit (`CYCLE_TIMEOUT_SECONDS`). Jika terlampaui, HOLD diterapkan dan ticker berikutnya segera dimulai.
