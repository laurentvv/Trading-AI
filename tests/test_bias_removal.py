...
def test_no_bullish_bias():
    ...
    market_data = {"volatility": 0.02, "rsi": 50, "macd": 0, "bb_position": 0.5}
    ...
    decision = engine.make_enhanced_decision(
        ...
        text_llm_decision={
            "signal": "HOLD",
            "confidence": 0.5,
            "analysis": "Neutral text analysis",
        },
        visual_llm_decision={
            "signal": "HOLD",
            "confidence": 0.5,
            "analysis": "Neutral visual analysis",
        },
        sentiment_decision={"signal": "HOLD", "confidence": 0.5},
        timesfm_decision={
            "signal": "HOLD",
            "confidence": 0.5,
            "analysis": "Neutral forecast",
        },
    ...
    decision2 = engine.make_enhanced_decision(
        ...
        text_llm_decision={
            "signal": "SELL",
            "confidence": 0.5,
            "analysis": "Bearish text",
        },
        visual_llm_decision={
            "signal": "SELL",
            "confidence": 0.5,
            "analysis": "Bearish visual",
        },
        sentiment_decision={"signal": "HOLD", "confidence": 0.5},
        timesfm_decision={
            "signal": "HOLD",
