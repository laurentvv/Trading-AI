...
- **Super-Consensus Boost**: Implements a logical layer that increases global confidence when objective quantitative models (Classic + TimesFM) agree on a strong directional signal.
