...
9.  **🏛️ Weekend Council (Mémoire Stratégique Hebdomadaire) :**
    *   **Rétrospective Multi-Personas :** Tous les samedis à 01:00, six personas IA (Stratège / Gestionnaire de Risque / Quant / Sceptique / Tacticien / Comportementaliste) délibèrent sur la semaine écoulée. Chaque membre tourne sur une **famille de modèle distincte (local Ollama + Cloud Gemini)** (Gemma 4 12B / GLM-4.6V-Flash / Qwen 3.5 9B / Gemini 2.5 Flash / Mistral Nemo 12B) pour garantir une **diversité de raisonnement réelle** — pas des changements de costume sur un seul modèle.
