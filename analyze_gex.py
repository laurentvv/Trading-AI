...
def analyze_gex():
    ...
    report_lines.extend(
        format_line(
            "1-Day",
            safe_calc(df["fwd_1d_ret"], pd.Series.mean),
            safe_calc(df["fwd_1d_ret"], pd.Series.std),
            safe_calc(gex_pos["fwd_1d_ret"], pd.Series.mean),
            safe_calc(gex_pos["fwd_1d_ret"], pd.Series.std),
            safe_calc(gex_neg["fwd_1d_ret"], pd.Series.mean),
            safe_calc(gex_neg["fwd_1d_ret"], pd.Series.std),
        )
    )
    ...
    report_lines.extend(
        format_line(
            "5-Day",
            safe_calc(df["fwd_5d_ret"], pd.Series.mean),
            safe_calc(df["fwd_5d_ret"], pd.Series.std),
            safe_calc(gex_pos["fwd_5d_ret"], pd.Series.mean),
            safe_calc(gex_pos["fwd_5d_ret"], pd.Series.std),
            safe_calc(gex_neg["fwd_5d_ret"], pd.Series.mean),
            safe_calc(gex_neg["fwd_5d_ret"], pd.Series.std),
        )
    )
    ...
    report_lines.extend(
        format_line(
            "20-Day",
            safe_calc(df["fwd_20d_ret"], pd.Series.mean),
            safe_calc(df["fwd_20d_ret"], pd.Series.std),
            safe_calc(gex_pos["fwd_20d_ret"], pd.Series.mean),
            safe_calc(gex_pos["fwd_20d_ret"], pd.Series.std),
            safe_calc(gex_neg["fwd_20d_ret"], pd.Series.mean),
            safe_calc(gex_neg["fwd_20d_ret"], pd.Series.std),
        )
    )
